...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-foreground selection:bg-primary/20 pb-20">
      {/* Visual Hero Banner */}
      <div className="w-full h-[50vh] md:h-[65vh] relative overflow-hidden bg-[#041E28]">
        <img 
          src={newTurtleImg} 
      ...
      {/* Header Section */}
      <header className="relative -mt-16 md:-mt-24 px-6 md:px-12 lg:px-24 max-w-5xl mx-auto z-10">
        <motion.div 
